...
class date20230423_rec1_whole(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "date20230423_rec1_whole")
        ...
        self.channel_bw = channel_bw = 800000
        self.center_offset = center_offset = -211750
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/orville/Downloads/good2go/gqrx_20230423_222551_914900000_2400000_fc.raw', False, 0, 0)
...
def main(top_block_cls=date20230423_rec1_whole, options=None):
